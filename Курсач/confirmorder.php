...
<form action="" method="post" class="content">
    <a href="orderdoc.php?id_order=<?=$id_order?>&rej=1&id_operator=<?=$idoperator?>&timeofdelivery=<?=$timeofdelivery?>" class="btn41">Показать документ</a>
    ...
    <p><a href="neworder_checknumber.php?timeofdelivery=<?=$timeofdelivery?>&id_operator=<?=$idoperator?>" class="btn4">Подтвердить</a></p>
</form>
<?php
