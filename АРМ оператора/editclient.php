...
<table class="createtable">
    ...
    <tr>
        ...
        <td>Квартира <br><input type = "number" name="txt6" id="txt6" autocomplete="off" class="textforcreateedit" placeholder = "123"
        value="<?php if ($id_client>0 || $id_order>0) echo $row['flat'];?>"></td>
        <td>Подъезд <br><input type = "number" name="txt7" id="txt7" autocomplete="off" class="textforcreateedit" placeholder = "2"
        value="<?php if ($id_client>0 || $id_order>0) echo $row['entrance'];?>"></td>
        <td>Этаж <br><input type = "number" name="txt8" id="txt8" autocomplete="off" class="textforcreateedit" placeholder = "12"
